 ...
 */
final class Version20230802091122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE departement (id INT AUTO_INCREMENT NOT NULL, chef_lieu_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, code VARCHAR(5) NOT NULL, UNIQUE INDEX UNIQ_C1765B63AD611528 (chef_lieu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
